...
209 lines (105 sloc)  17.4 KB
CONDIÇÕES GERAIS DE UTILIZAÇÃO DO "NOME COMPLETO DO SISTEMA".
Este arquivo foi criado com extensão .md porque a exibição fica bem legal no GitHub. Será disponibilizado um link para download, caso você não possua conta. Aproveitando, que tal criar sua conta agora? \o/
...
a) Não cumprimento das obrigações pela outra parte; e b) Falência, recuperação judicial ou extrajudicial de quaisquer das partes.
